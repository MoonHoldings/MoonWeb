      ...
      <div className="main-modal w-[60.5rem] rounded-[2rem] bg-[#191C20] p-[2rem] drop-shadow-lg">
        ...
        >
          {addAddressStatus === 'loading' ? (
            <>
              <div
                class="mr-[1rem] inline-block h-8 w-8 animate-spin rounded-full border border-4 border-solid border-current border-r-transparent align-[-0.125em] motion-reduce:animate-[spin_1.5s_linear_infinite]"
                role="status"
              >
